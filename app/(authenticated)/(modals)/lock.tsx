...
const Page = () => {
  ...
  useEffect(() => {
    if (code.length === 6) {
      // load keystore password/code for authentication
      if (code.join("") === "111111") {
  ...
  const onBiometricAuthPress = async () => {
    // add checking of biometrics permission
    ...
    <SafeAreaView>
      ...
      <View style={styles.numbersView}>
        ...
        >
          ...
          <TouchableOpacity onPress={() => onNumbersPress(0)}>
